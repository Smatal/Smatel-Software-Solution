    ...
    <section className="py-24 relative overflow-hidden bg-gray-900">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20 text-center max-w-3xl">
        ...
        >
          <Link
            href="/contact"
            className={cn(buttonVariants({ size: "lg", className: "h-14 px-8 text-base bg-indigo-600 hover:bg-indigo-500 text-white shadow-[0_0_30px_-5px_rgba(79,70,229,0.5)] border-none w-full sm:w-auto" }))}
          >
