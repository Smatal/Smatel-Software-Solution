...
interface HeroWrapperProps extends React.ComponentPropsWithoutRef<typeof motion.section> {
  children: React.ReactNode;
}

export function AnimatedHeroWrapper({ children, className, ...props }: HeroWrapperProps) {
